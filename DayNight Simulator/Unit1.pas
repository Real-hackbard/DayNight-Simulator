...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, XPMan, Vcl.ComCtrls;
...
procedure TForm1.CAktuellClick(Sender: TObject);
begin
...
procedure TForm1.CGradNetzClick(Sender: TObject);
begin
...
procedure TForm1.BDarstellungClick(Sender: TObject);
...
procedure TForm1.BSimulationClick(Sender: TObject);
begin
  timer1.enabled:= not timer1.enabled;
  if timer1.enabled then begin
    CAktuell.checked:=false;
    BSimulation.caption:='Stop'
  end
...
procedure TForm1.BAktuellClick(Sender: TObject);
var st,mi,se,ms:word;
    ja,ta,mo:word;
begin
  decodetime(time,st,mi,se,ms);
